			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="{{route('pendaftaran')}}">Pendaftaran</a></li>
	...
	<div id="carouselExampleControls" class="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active">
				<div id="home" class="first-section" style="background-image:url({{url('assets/home/images/slider-01.jpg')}});">
					<div class="dtab">
						<div class="container">
							<div class="row">
			...
			<div class="carousel-item">
				<div id="home" class="first-section" style="background-image:url({{url('assets/home/images/slider-02.jpg')}});">
					<div class="dtab">
						<div class="container">
							<div class="row">
			...
			<div class="carousel-item">
				<div id="home" class="first-section" style="background-image:url({{url('assets/home/images/slider-03.jpg')}});">
					<div class="dtab">
						<div class="container">
							<div class="row">
