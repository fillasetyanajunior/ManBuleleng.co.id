        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row align-items-center mb-2">
                    <div class="col">
                        <h2 class="h5 page-title">Jurusan</h2>
                    </div>
                    <div class="col-auto">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                                        <a class="dropdown-item" href="" id="editjurusan" data-toggle="modal" data-target="#jurusanModal" data-id="{{$item->id}}">Edit</a>
...
<div class="modal fade" id="jurusanModal" tabindex="-1" aria-labelledby="ModalJurusanLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body body_jurusan">
