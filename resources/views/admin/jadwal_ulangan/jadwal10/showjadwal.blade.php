        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row align-items-center mb-2">
                    <div class="col">
                        <h2 class="h5 page-title">Jadwal Ulangan Kelas 10</h2>
                    </div>
                    <div class="col-auto">
                        <div class="d-flex flex-row-reverse bd-highlight">
                            <div class="p-2 bd-highlight">
                                <a href="" class="btn mb-2 btn-primary " id="tambahulangan10" data-toggle="modal" data-target="#ulangan10Modal"><i class="fas fa-plus"></i><span>&nbsp; Tambah Jadwal</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card shadow">
                            <div class="card-header">
                                <strong class="card-title">Jadwal Ulangan Kelas 10</strong>
                            </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                                        <a class="dropdown-item" href="" id="editulangan10" data-toggle="modal" data-target="#ulangan10Modal" data-id="{{$jadwal->id}}">Edit</a>
                                                        <form action="/ulangan10/delete/{{$jadwal->id}}" method="post" >
                                                            @csrf
                                                            @method('delete')
...
<!-- Modal -->
<div class="modal fade" id="ulangan10Modal" tabindex="-1" aria-labelledby="ModalUlangan10Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalUlangan10Label">Modal title</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body body_ulangan10">
                ...
                <div class="modal-footer footer_ulangan10">
